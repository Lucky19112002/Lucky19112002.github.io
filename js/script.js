...
ScrollReveal().reveal('.home-img, .services-container , .proj-box , .contact ,from ,.badge-table', { origin: 'bottom' });
ScrollReveal().reveal('.home-content h1 , .about-banner', { origin: 'left' });
